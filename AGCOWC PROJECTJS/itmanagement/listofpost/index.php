...
<div id="mySidebar" class="sidebar">
  ...
  <a href="index.php">List Of Post</a>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex d-flex justify-content-between">
                            <div class="lead">List Of Post By Admins</div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="table table-success table-striped" v-if="records.length">
                            <table class="table table-borderless">
                                ...
                                <tbody>
                                    <tr v-for="(record, i) in records" :key="record.post_id">
                                        <td>{{i + 1}}</td>
                                        <td>{{record.post_date}}</td>
                                        <td>{{record.user_title}}</td>
                                        <td>{{record.user_post}}</td>
                                        <td>{{record.id}}</td>
                                        <td>
                                            <a href="#" @click.prevent="deleteRecord(record.post_id)" class="btn btn-danger">Delete</a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
