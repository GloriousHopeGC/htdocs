    ...
    <div class="modal-dialog" role="document">
      ...
      <div class="modal-header">
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" style="align-content: end;"></button>
            ...
            <!-- Forms In Modal -->
                <form action="./api/login_query.php" method="POST" autocomplete="off">
    ...
    <div class="modal-dialog" role="document">
      ...
      <div class="modal-header">
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" style="align-content: end;"></button>
            ...
            <div class="modal-body">
            <!-- Forms In Modal -->
                <form action="./api/register_query.php" method="POST" enctype="multipart/form-data" autocomplete="off">
...
<section id="announcement" style="background-color:#a7a7a7;;">
