            ...
            <div id="vueregapp">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control my-2" ref="title" v-model="regDetails.title" v-on:keyup="keymonitor" placeholder="Write Title">
                            <textarea class="form-control my-2"  ref="post" v-model="regDetails.post" v-on:keyup="keymonitor" placeholder="Write Announcement:" style="transition: height 0.3s;"  v-bind:style="{ height: textareaHeight + 'px' }" v-on:click="expandTextarea" required></textarea>
